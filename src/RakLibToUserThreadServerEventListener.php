...
interface RakLibToUserThreadServerEventListener{

	public function onClientConnect(int $sessionId, string $address, int $port, int $clientID, RakLibToUserThreadSessionMessageReceiver $ipcReceiver) : void;
